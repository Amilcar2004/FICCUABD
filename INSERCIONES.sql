...
(4, N'Medico', N'Personal medico, puede escanear QR de credenciales y ver expedientes medicos.', 1),
(5, N'Voluntariado-Voluntario', N'Voluntario de los eventos, puede escanear QR de credenciales para control de acceso.', 1),
(6, N'Alimentacion-Supervisor', N'Puede controlar la entrega de tiempos de comida de un comedor en especifico.', 1),
(7, N'Alimentacion-Voluntario', N'Puede escanear QR de credenciales para entrega de tiempos de comida.', 1),
(8, N'Alimentacion-Administrador', N'Puede controlar los comedores y entregas de tiempos de comida.', 1),
